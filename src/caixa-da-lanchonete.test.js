...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['com desconto de 5%', 'dinheiro', 'R$ 8,55', ['cafe,3']],
    ])('compra com %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    
    test.each([
        ['com acréscimo de 3%', 'credito', 'R$ 22,66', ['cafe,3', 'sanduiche,2']],
    ])('compra com %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
